...
protocol MovieDBAPI {
    ...
    func fetchMovie(id: Int, successHandler: @escaping (_ response: MovieData) -> Void, errorHandler: @escaping(_ error: Error) -> Void)
    
    func fetchnextpageMovies(from endpoint: Endpoint, pageNum:Int, params: [String: String]?, successHandler: @escaping (_ response: MoviesResponse) -> Void, errorHandler: @escaping(_ error: Error) -> Void)
